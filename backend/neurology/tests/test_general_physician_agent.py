...
from backend.neurology import (
    _build_initial_doctor_message,
    _sanitize_tests,
    _should_recommend_tests,
)
from backend.neurology import agent as gp_agent
from backend.neurology.models.session_state import DoctorState
...
class GeneralPhysicianAgentTests(unittest.TestCase):
    ...
    def test_persist_consultation_output_updates_context_metadata(self):
        ...
        with patch("backend.neurology.agent.upsert_consultation_context") as mock_upsert:
