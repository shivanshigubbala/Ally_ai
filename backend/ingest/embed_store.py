...
Usage:
    python -m backend.ingest.embed_store <chunks.jsonl> <department>
"""
...
try:
    ...
    from db.pgvector_tracker import (  # noqa: E402
        count_knowledge_chunks,
        init_db,
        insert_knowledge_chunks,
    )
    from llm.embeddings import embed_passages  # noqa: E402
...
def main() -> int:
    if len(sys.argv) != 3:
        print("usage: python -m backend.ingest.embed_store <chunks.jsonl> <department>")
        return 2
