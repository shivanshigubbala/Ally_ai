"""
Unit tests for backend.cardiology.db.pgvector_tracker.sync_go_user_id
...
from backend.cardiology.db.pgvector_tracker import _ensure_schema_compatibility, sync_go_user_id


class TestSyncGoUserId(unittest.TestCase):
    """Test sync_go_user_id function."""

    @patch('backend.cardiology.db.pgvector_tracker._conn')
    ...
    @patch('backend.cardiology.db.pgvector_tracker._conn')
    @patch('backend.cardiology.db.pgvector_tracker.create_user')
