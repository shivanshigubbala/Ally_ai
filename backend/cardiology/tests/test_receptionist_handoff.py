...
def test_receptionist_emits_canonical_intake_contract() -> None:
    ...
    with patch("backend.cardiology.graphs.routing_graph.nv_chat") as mock_chat:
...
async def test_router_emits_doctor_ready_instead_of_auto_switch() -> None:
    ...
    from backend.cardiology.ws.router import _drive_routing
    ...
    from backend.cardiology.ws.router import _user_state
