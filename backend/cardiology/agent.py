...
def _build_initial_doctor_message(chief_complaint: str | None, patient_name: str, doctor_name: str = "Dr. Arjun Reddy", dept_name: str = "cardiology") -> str:
...
LAB_TESTS = [
    ...
    },
    {
        ...
        "reason": "Measures the electrical activity of the heart.",
    },
]
...
def session_init(state: DoctorState, emit: Emitter) -> DoctorState:
    ...
    doc_name = state.doctor_name or department_context.get("doctor_name") or "Dr. Arjun Reddy"
...
class GeneralPhysicianSpecialty(_GeneralPhysicianSpecialty):
    """Compatibility adapter for the shared GP workflow inside cardiology tests."""
...
class CardiologySpecialty(BaseSpecialty):
    """Adapter for the Cardiology workflow (Dr. Arjun Reddy) in the shared specialty framework."""
